...
class ClipLossWithDINORegularization(nn.Module):
    def __init__(
        self,
        local_loss=False,
        gather_with_grad=False,
        ...
        world_size=1,
        use_horovod=False,
        lambda_dino=0.1,  # Regularization strength for DINO similarities
    ):
        super().__init__()
        self.local_loss = local_loss
        self.gather_with_grad = gather_with_grad
        ...
        self.world_size = world_size
        self.use_horovod = use_horovod
        self.lambda_dino = lambda_dino  # DINO regularization strength
    ...
    def forward(
        ...
        # Compute DINO regularization term (if DINO similarities are provided)
        dino_regularization = 0.0
        ...
        # Return loss in dictionary format if requested
        if output_dict:
            return {
                "contrastive_loss": contrastive_loss,
                "dino_regularization": dino_regularization,
